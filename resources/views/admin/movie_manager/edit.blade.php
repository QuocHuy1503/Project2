...
@section('content')
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Sửa thông tin phim #{{ $movie->id }}</h1>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="status" id="status" class="form-control">
                                        <option {{($movie->status == 1) ? 'selected' : ''}} value="1" >Chiếu</option>
                                        <option {{($movie->status == 0) ? 'selected' : ''}} value="0" >Không chiếu</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
{{--                                                            @endif--}}
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <input type="text" value="{{ $movie->director }}" name="director" id="director" class="form-control" placeholder="Nhập tên đạo diễn">
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <input type="text" value="{{$movie->language}}" name="language" id="language" class="form-control" placeholder="Ngôn ngữ">
                                </div>
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <select name="is_featured" id="is_featured" class="form-select">
                                        <option {{($movie->is_featured == 'No') ? 'selected' : ''}} value="No" >Không</option>
                                        <option {{($movie->is_featured == "Yes") ? 'selected' : ''}} value="Yes" >Có</option>
                                    </select>
                                </div>
                            </div>
                        </div>
