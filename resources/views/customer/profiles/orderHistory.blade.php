...
@section('content')
    ...
    <hr class="text-white">
    <div class="container d-flex align-items-center mt-5 h-100 overflow-hidden">
        ...
        <div class="border w-80 rounded-end p-3 h-100 text-white" style="background-color: #191c33">
            <section class="justify-content-lg-between">
                ...
                <div>
                    ...
                    <div>
                        Quản lý lịch sử đặt vé của bạn
                    </div>
                </div>
            </section>
            <hr>

            <div id="vertical-scroller" style="width: 68.9%">
                    ...
                    <div class="ticket">
                        <div class="ticket__main">
                                ...
                                <div class="info passenger">
                                    ...
                                    <div class="info__detail">{{ $order->screening->movie->title }}</div>
                                </div>
                                <div class="info platform"> <span> </span><span></span><span class="fs-3">Chúc bạn xem phim vui vẻ</span>
                                </div>
                                <div class="info departure">
                                    <div class="info__item">Phòng chiếu</div>
                                    <div class="info__detail">{{ $order->screening->auditorium->name }}</div>
                                </div>
                                <div class="info arrival">
                                    <div class="info__item">Người đặt</div>
                                    <div class="info__detail">{{ $order->customer->first_name .' '. $order->customer->last_name  }}</div>
                                </div>
                                <div class="info date">
                                    <div class="info__item">Ngày đặt</div>
                                    <div class="info__detail">{{ \Carbon\Carbon::parse($order->date)->format('d-m-Y') }}</div>
                                </div>
                                <div class="info time">
                                    <div class="info__item">Thời gian chiếu</div>
                                    <div class="info__detail">{{ \Carbon\Carbon::parse($order->screening->screening_start)->format('H:i') }} -
                                        {{ \Carbon\Carbon::parse($order->screening->screening_end)->format('H:i A') }}
                                    </div>
                                </div>
