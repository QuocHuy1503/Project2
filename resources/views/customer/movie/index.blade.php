                                ...
                                @foreach($movies as $movie)
                                    <div class="p-3 rounded rounded-4 " style=" background: linear-gradient(45deg, rgba(255,255,255, .05), rgba(205,140,56,.15));">
                                        @if(!empty($movie->image))
                                            <div class="position-relative rounded rounded-4 overflow-hidden mb-3" style="width: auto; height: 150px;">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <a href="#" class="btn btn-outline-success text-white border-light-subtle">View Detail <span class="bi bi-exclamation-circle"></span></a>
                                            <a href="#" class="btn btn-outline-danger text-white border-white">Buy Tickets</a>
                                        </div>
                                    </div>
