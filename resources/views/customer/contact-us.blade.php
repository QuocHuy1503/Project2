            ...
            <div class="container">
                <div class="light-font">
                    <ol class="breadcrumb  mb-0">
                        ...
                        <li class="bi bi-slash-lg text-white">Contact Us</li>
                    </ol>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-6">
                        <form class="shake" role="form" method="post" id="contactForm" name="contact-form">
                            ...
                            <div class="form-submit">
                                <button class="btn btn-danger" type="submit" id="form-submit"><i class="material-icons mdi mdi-message-outline"></i> Send Message</button>
