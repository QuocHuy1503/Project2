            ...
            <div class="container-fluid my-2">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{route('auditorium.create')}}" class="bi bi-plus-circle btn btn-primary">New Auditorium</a>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
                            ...
                            @if($auditoriums->count() > 0)
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="deleteGenre({{ $auditorium ->id }})" class="text-danger w-4 h-4 mr-1">
