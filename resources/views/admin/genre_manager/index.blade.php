            ...
            <div class="container-fluid my-2">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{route('genre.create')}}" class="bi bi-plus-circle btn btn-primary"> Thêm thể loại mới</a>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover table-bordered text-nowrap">
                            ...
                            @if($genres->count() > 0)
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="deleteGenre({{ $genre->id }})" class="text-danger w-4 h-4 mr-1">
                            ...
                            @else
                                <tr>
                                    <td colspan="5">Không tìm thấy thể loại nào</td>
                                </tr>
                            @endif
...
@section('customJs')
    <script>
        function deleteGenre(id) {
            var url = '{{ route('genre.destroy', 'ID') }}';
