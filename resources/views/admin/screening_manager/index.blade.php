                    ...
                    <form action="" method="get">
                        <div class="card-header">
                            <div class="card-title">
                                <button type="button" onclick="window.location.href='{{route('screening.index')}}'" class="btn btn-default btn-sm">
                                    Reset
                                </button>
                            </div>
                            ...
                            @if($screenings->count() > 0)
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="deleteScreening({{ $screening->id }})" class="text-danger w-4 h-4 mr-1">
